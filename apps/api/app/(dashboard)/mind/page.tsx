...
const TOOLS = [
  {
    href:  '/mind/support?tool=breathe',
    icon:  Wind,
    label: 'Breathe With Me',
    desc:  'Follow a slow, guided breathing exercise to calm your nervous system.',
    sub:   '~1 minute',
    color: '#4A7A5F',
    bg:    'rgba(74,122,95,0.08)',
  },
  {
    href:  '/mind/support?tool=grounding',
    icon:  Hand,
    label: 'Come Back to Now',
    desc:  'Use your five senses to ground yourself in the present moment.',
    sub:   '5 senses',
    color: '#4A8FAF',
    bg:    'rgba(74,143,175,0.08)',
  },
  {
    href:  '/mind/support?tool=stop',
    icon:  PauseCircle,
    label: 'Pause Before Reacting',
    desc:  'A four-step technique to interrupt automatic reactions with intention.',
    sub:   '4 steps',
    color: '#8B7EC8',
    bg:    'rgba(139,126,200,0.08)',
  },
  {
    href:  '/mind/support?tool=urge',
    icon:  Waves,
    label: 'Ride the Wave',
    desc:  'Observe difficult feelings without acting on them until they pass.',
    sub:   '~1 minute',
    color: '#5E8B71',
    bg:    'rgba(94,139,113,0.08)',
  },
  {
    href:  '/mind/support?tool=opposite',
    icon:  RotateCcw,
    label: 'Choose a Helpful Next Step',
    desc:  'Identify one small action that moves you in a positive direction.',
    sub:   '3 steps',
    color: '#C05570',
    bg:    'rgba(192,85,112,0.08)',
  },
  {
    href:  '/mind/support?tool=wise',
    icon:  Brain,
    label: 'Find Your Calm Self',
    desc:  'Connect with the part of you that is balanced, wise, and at ease.',
    sub:   '3 steps',
    color: '#7B6DB8',
    bg:    'rgba(123,109,184,0.08)',
  },
]
    ...
    <div>
      ...
      <div className="px-7 md:px-10 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="text-xs" style={{ color: 'var(--stable-t3)' }}>{TOOLS.length} guided exercises</span>
        </div>
