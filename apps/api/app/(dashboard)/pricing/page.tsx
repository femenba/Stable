...
export default function PricingPage() {
  const { data: sub, isLoading } = trpc.subscriptions.getStatus.useQuery()
  ...
  const proButtonLabel = () => {
    ...
    if (pastDue)  return 'Update payment details'
  ...
  return (
    <div>
      ...
      >
        <div style={{ position: 'absolute', top: -60, right: -40, width: 300, height: 300,
          borderRadius: '50%', background: 'rgba(74,122,95,0.08)',
          filter: 'blur(70px)', pointerEvents: 'none' }} />
        <div className="relative px-7 md:px-10 pt-10 pb-10 text-center max-w-2xl mx-auto">
          <p className="text-xs font-semibold uppercase tracking-widest mb-3"
             style={{ color: 'var(--stable-t3)' }}>PRICING</p>
          <h1 className="text-[32px] md:text-[44px] font-black leading-[1.1] mb-3"
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="mb-8">
              <span className="text-[44px] font-black leading-none"
                    style={{ color: 'var(--stable-t1)' }}>£0</span>
              <span className="text-sm font-medium ml-1"
                    style={{ color: 'var(--stable-t3)' }}>/month</span>
            </div>
            ...
            <div
              ...
              style={{ background: 'var(--stable-bg)', border: '1px solid var(--stable-card-border)',
                color: 'var(--stable-t2)' }}
            >
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6 relative">
              ...
              {pastDue && (
                <span className="ml-auto text-[10px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full"
                      style={{ background: 'rgba(255,60,60,0.4)', color: '#fff' }}>
                  Payment failed
                </span>
              )}
            </div>
            ...
            <div className="mb-8 relative">
              ...
              <span className="text-sm font-medium ml-1"
                    style={{ color: 'rgba(255,255,255,0.65)' }}>/month</span>
            </div>
            ...
            <button
              ...
              disabled={isLoading || redirecting || checkoutMutation.isPending || portalMutation.isPending}
              className="relative w-full py-3.5 rounded-full text-sm font-black text-center transition-all hover:opacity-90 disabled:opacity-60 flex items-center justify-center gap-2"
              style={{ background: 'rgba(255,255,255,0.92)', color: 'var(--sage-dark)' }}
            >
              {redirecting || checkoutMutation.isPending || portalMutation.isPending
