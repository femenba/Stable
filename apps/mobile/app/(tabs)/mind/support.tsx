...
const bStyles = StyleSheet.create({
  ...
  circle: {
    ...
    shadowColor: '#5E8B71', shadowOffset: { width: 0, height: 8 },
...
const scrnStyles = StyleSheet.create({
  ...
  section:      { borderRadius: 22, borderWidth: 1, padding: 20, gap: 16, shadowColor: '#5E8B71', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.06, shadowRadius: 12, elevation: 2 },
  ...
  card:         { borderRadius: 20, borderWidth: 1, overflow: 'hidden', shadowColor: '#5E8B71', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 2 },
