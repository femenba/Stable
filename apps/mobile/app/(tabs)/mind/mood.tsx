...
const styles = StyleSheet.create({
  ...
  updateBtn:      { borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 24, paddingVertical: 10 },
  updateBtnText:  { fontSize: 14, fontWeight: '600' },
  noteInput: {
    borderWidth: 1, borderRadius: 14,
    paddingHorizontal: 16, paddingVertical: 12,
    fontSize: 15, minHeight: 70,
  },
  logBtn:         { borderRadius: 16, paddingVertical: 18, alignItems: 'center' },
  logBtnText:     { color: '#fff', fontSize: 16, fontWeight: '800', letterSpacing: 0.3 },
